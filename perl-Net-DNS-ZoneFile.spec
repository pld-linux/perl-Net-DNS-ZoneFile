...
Summary(pl):	Net::DNS::ZoneFile - konwersja pliku stref do zbioru rekordów RR
...
%description -l pl
Ten modu³ analizuje plik strefy i zwraca referencjê do tablicy
obiektów Net::DNS::RR zawieraj±cych wszystkie RR podane w strefie - w
